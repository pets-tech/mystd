...
class unordered_multiset {
 private:
  ...
  using Base = hashtable<Value, Value, Identity, Hash, KeyEqual, InsertPolicy::AllowDuplicates>;
  Base table;
 ...
 public:
  ...
  // ctor
  unordered_multiset(const size_type bucket_count = 8) : table(bucket_count) {};

  // initializer_list ctor
  unordered_multiset(const std::initializer_list<Value>& init) : unordered_multiset() {
