...
class list {
 ...
 private:
  ...
  class iterator_basic {
   public:
    ...
    bool operator==(const iterator_basic& rhs) const { return current_ == rhs.current_; }
    bool operator!=(const iterator_basic& rhs) const { return !(*this == rhs); }
 ...
 public:
  ...
  list(list&& other) noexcept
      : storage_(std::move(other.storage_)), head_(other.head_), tail_(other.tail_), size_(other.size_) {
    other.head_ = npos;
    other.tail_ = npos;
    other.size_ = 0;
  }
